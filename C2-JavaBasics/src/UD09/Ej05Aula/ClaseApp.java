...
public class ClaseApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("El aula es de "+Primera.materia+", es la número "+Primera.numAula+" y tiene una capacidad máxima de "+Primera.maxAlumno+" alumnos.");
...
//		alumnos.toString();
//		ausencias.ausenciaString();
		Profesor profesor = new Profesor();
		if (alumnos.size() >= Primera.maxAlumno / 2 && !profesor.getAusencia() && profesor.materia == Primera.materia) {
